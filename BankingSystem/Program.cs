...
namespace BankingSystem
{
    class Program
    {
        static int GanerateSavingsAccountNumber(int i)
        {
            int start = 1000;
            int accountNumber = start + i;
            return accountNumber;
        }
        static int GanerateCheakingAccountNumber(int i)
        {
            int start = 20000;
            int accountNumber = start + i;
            return accountNumber;
                    ...
                    case "open"://open account
                        ...
                        if (menu2 == 1)
                        {
                            ...
                            for (int i = 0; i < size; i++)
                            {
                                ...
                                Account obj = new SavingsAccount(GanerateSavingsAccountNumber(i), userName, dateOfBirth, balance, address);
                        ...
                        else if (menu2 == 2)
                        {
                            ...
                            for (int i = 0; i < size; i++)
                            {
                                ...
                                Console.WriteLine("Address:--House No, Road No, City, Country\n     ");
                                string address = Console.ReadLine();
                                Account obj = new CheckingAccount(GanerateCheakingAccountNumber(i), userName, dateOfBirth, balance, address);
